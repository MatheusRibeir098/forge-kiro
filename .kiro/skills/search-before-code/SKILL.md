...
description: Obriga pesquisa de documentacao e versoes atuais antes de escrever codigo com bibliotecas, frameworks ou APIs externas. Use antes de adicionar dependencia, integrar API de terceiro, ou escolher lib para uma stack.
---
