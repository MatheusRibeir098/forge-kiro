...
description: Proibicao de deploy, push e publicacao sem autorizacao explicita do usuario. Use antes de git push, cdk deploy, terraform apply, npm publish, ou qualquer comando que altere ambiente remoto ou repositorio compartilhado.
---
