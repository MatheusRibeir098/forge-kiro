---
name: meta-prompt
description: Engenharia de especificacao conversacional (CPE) para extrair requisitos do usuario e gerar um prompt.md completo de projeto. Use quando o usuario quer criar um projeto do zero e a ideia ainda esta vaga.
---
